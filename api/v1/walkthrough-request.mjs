    ...
    try {
      ...
      if (
        Object.keys(body).some(
          (k) => !Object.hasOwn(fields, k) && k !== "website",
        )
      )
        throw new IntakeError(
          422,
          "validation_failed",
          "Please use the documented fields.",
          { _form: "Unexpected field in request." },
        );
      ...
      return json(res, err.status, {
        ...
        code: err.code,
        message: err.message,
        ...(Object.keys(err.fields).length ? { field_errors: err.fields } : {}),
      });
    }
  };
}
